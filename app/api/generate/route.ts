	...
	try {
		...
		if (apiKeys.length === 0) {
			return NextResponse.json(
				{ error: "Nu a fost găsită nicio cheie API Gemini." },
				{ status: 500 },
			);
		}
						...
						responseSchema: {
							...
							properties: {
								...
								toxicWords: {
									...
									description:
										"Lista de cuvinte toxice sau manipulatoare din text (fără punctuație, litere mici).",
								},
								explanation: {
									type: Type.STRING,
								...
								emotions: {
									type: Type.OBJECT,
									description:
										"Scoruri de la 0 la 100 pentru emoțiile declanșate de text.",
									properties: {
			...
			const FALLBACK_ARTICLES = [
				{
					...
					explanation:
						"Textul folosește hiperbole ('apocalipsă', 'catastrofal') și cuvinte cu încărcătură emoțională negativă ('lacome') pentru a declanșa frica. Cuvântul 'catastrofal' scurtcircuitează gândirea rațională, determinând cititorul să accepte soluții extreme.",
				...
				},
				{
					...
					explanation:
						"Acest text folosește limbaj conspirativ ('elita globalistă', 'farsă monumentală') și acuzații grave ('corupți', 'mint') pentru a crea indignare. Cuvântul 'șocant' declanșează o reacție emoțională care blochează analiza critică.",
